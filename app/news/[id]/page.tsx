...
> = {
  ...
  "2025-diamond-copper": {
    ...
    icon: Cpu,
    content: [
      "在高性能热管理领域，簇锋科技取得了里程碑式的进展。经过上百次的配方优化与界面润湿性实验，我们成功开发出新一代金刚石铜复合材料。",
      "实测数据显示，该材料样品的室温热导率稳定达到680 W/m·K以上，远超传统纯铜（380 W/m·K）及常规铝碳化硅材料。",
      "通过独特的界面键合技术，我们有效解决了金刚石与铜之间热胀系数不匹配导致的分层难题。这一产品的成功开发，标志着簇锋科技正式进入全球高功率密度电子器件（如AI芯片、大功率激光器）散热方案的供应商行列，为解决算力热瓶颈提供了核心材料支撑。",
    ],
  },
  "2024-nonstick": {
    date: "2024年",
    ...
    icon: ChefHat,
    content: [
      "簇锋科技始终坚持高精尖技术民用化的理念。2024年，我们将工业级金刚石颗粒固着技术引入消费品领域，成功研发出新型金刚石涂层不粘锅。",
  ...
  "2023-brazing-tools": {
    ...
    icon: Wrench,
    content: [
      "回归工程初心，公司在超硬工具领域再次取得突破。2023年，针对高精度医疗器械及工业精密加工需求，我们成功开发出高强度牙科磨头与活性熔固CBN（立方氮化硼）砂轮系列。",
  ...
  "2023-relocation": {
    ...
    icon: MapPin,
    content: [
      "为了响应产业升级趋势并获取更优质的科创资源，簇锋科技正式由镇江迁址至南京市江北新区。",
      "南京作为全国领先的科研中心，为公司提供了丰富的半导体产业链配套及高校人才支持。在江北新区的新型研发平台支撑下，我们进一步优化了实验室配置，并与多家产业链上下游企业建立了战略联系。",
      "此次迁址不仅是地理位置的移动，更是公司战略中心的全面提升，标志着簇锋科技正式步入研发驱动型企业的发展快车道。",
    ],
  },
  "2022-team": {
    date: "2022年",
    ...
    icon: Users,
    content: [
      "企业的灵魂在于人。2022年，簇锋科技确立了以技术研发、工程实施、业务拓展为核心的三人高管架构。",
  ...
  "2018-research-center": {
    ...
    icon: Building,
    content: [
      "在公司成立初期，我们就意识到核心技术自研的重要性。2018年6月，簇锋科技研发中心正式挂牌成立。",
      "中心初始配置了真空活性熔固炉、金相显微镜及精密力学测试仪等关键设备，专注于超硬磨料工具的底层机理研究。",
