...
/**
 * 抽象波浪几何背景 - 与参考图一致的深蓝科技风格
 * 主色：#003366 海军蓝，辅以青蓝高光，含浮动圆形元素
 */
export function HeroWaveBg() {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div className="absolute top-[10%] right-[35%] w-40 h-28 rounded-full bg-[#1a3099]/20" style={{ transform: "rotate(-15deg)" }} />
      <div className="absolute bottom-[30%] left-[15%] w-48 h-36 rounded-full bg-[#0096c7]/15" style={{ transform: "rotate(10deg)" }} />
