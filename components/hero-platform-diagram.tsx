  ...
  return (
    <div className="w-full max-w-5xl mx-auto rounded-2xl border border-[#0077b6]/40 bg-[#001a33]/60 overflow-hidden shadow-xl shadow-[#0077b6]/10">
      ...
      <div className="px-3 py-4 sm:px-5 sm:py-5">
        ...
        {/* 下方：sp²+原子级共价桥接+sp³ 合并占两格位置，与左起两卡片对齐；第三格为原子级界面工程 */}
        <div className="mt-4 grid grid-cols-1 lg:grid-cols-[1fr_auto_1fr_auto_1fr] items-stretch gap-3 sm:gap-4 lg:gap-4">
          {/* 合并格：sp² 结构层 | 原子级共价桥接 | sp³ 结构层，占前两卡片位置 */}
          <div className="lg:col-span-3 flex items-stretch justify-between gap-0 rounded-xl overflow-hidden border border-[#00b4d8]/40 bg-[#001a33]/90 min-h-[64px] sm:min-h-[72px]">
            <div className="flex flex-col items-center justify-center flex-[0_0_28%] sm:flex-[0_0_30%] py-3 px-2">
              <span className="font-mono font-semibold text-[#7dd3fc] text-sm mb-1">{s.sp2LayerLabel}</span>
              <svg viewBox="0 0 52 28" className="w-full max-w-[56px] sm:max-w-[64px] h-auto text-[#00b4d8]/80" aria-hidden>
                <path d="M8 14 L14 10 L20 14 L20 20 L14 24 L8 20 Z" fill="none" stroke="currentColor" strokeWidth="1" opacity="0.95" />
                <path d="M20 14 L26 10 L32 14 L32 20 L26 24 L20 20 Z" fill="none" stroke="currentColor" strokeWidth="1" opacity="0.95" />
                <path d="M32 14 L38 10 L44 14 L44 20 L38 24 L32 20 Z" fill="none" stroke="currentColor" strokeWidth="1" opacity="0.95" />
                <path d="M14 20 L20 14 L26 20 L26 26 L20 30 L14 26 Z" fill="none" stroke="currentColor" strokeWidth="0.95" opacity="0.85" />
            ...
            <div className="flex flex-1 flex-col items-center justify-center px-2 sm:px-3 py-3 bg-gradient-to-r from-[#002244]/90 via-[#002a50]/95 to-[#002244]/90 border-x border-[#00b4d8]/25">
              <span className="page-caption text-[#73DBFF] font-semibold text-center leading-tight">{s.layer4MeltLabel}</span>
              <svg viewBox="0 0 80 28" className="mt-1.5 w-full max-w-[80px] sm:max-w-[96px] h-auto text-[#00b4d8]/90" aria-hidden>
                <circle cx="16" cy="14" r="4" fill="none" stroke="currentColor" strokeWidth="1.2" opacity="0.95" />
                <circle cx="40" cy="14" r="4" fill="none" stroke="currentColor" strokeWidth="1.2" opacity="0.95" />
                <circle cx="64" cy="14" r="4" fill="none" stroke="currentColor" strokeWidth="1.2" opacity="0.95" />
                <line x1="20" y1="14" x2="36" y2="14" stroke="currentColor" strokeWidth="2" opacity="0.9" className="text-[#73DBFF]" />
            ...
            <div className="flex flex-col items-center justify-center flex-[0_0_28%] sm:flex-[0_0_30%] py-3 px-2">
              <span className="font-mono font-semibold text-[#7dd3fc] text-sm mb-1">{s.sp3LayerLabel}</span>
              <svg viewBox="0 0 48 48" className="w-full max-w-[48px] sm:max-w-[56px] h-auto text-[#00b4d8]/90" aria-hidden>
                <path d="M24 0 L6 14 L10 24 L24 46 L38 24 L42 14 Z" fill="none" stroke="currentColor" strokeWidth="1.2" opacity="0.95" />
                <path d="M24 0 L10 24 M24 0 L38 24" fill="none" stroke="currentColor" strokeWidth="0.85" opacity="0.88" />
                <path d="M10 24 L38 24" fill="none" stroke="currentColor" strokeWidth="0.8" opacity="0.85" />
                <path d="M24 46 L10 24 M24 46 L38 24" fill="none" stroke="currentColor" strokeWidth="0.85" opacity="0.88" />
          ...
          <div className="flex flex-col items-center justify-center rounded-xl border border-[#00b4d8]/40 bg-[#001a33]/90 min-h-[64px] sm:min-h-[72px] py-3 px-3">
            <div className="flex items-center gap-2">
              <ArrowLeft className="w-4 h-4 text-[#7dd3fc] shrink-0" aria-hidden />
              <span className="text-[#7dd3fc] font-semibold text-sm text-center">{s.atomicTitle}</span>
            </div>
          </div>
        </div>
      </div>
