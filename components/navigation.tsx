      ...
      {mobileMenuOpen && (
        <>
          ...
          <div
            ...
            className="fixed top-16 right-0 w-full max-w-[200px] sm:max-w-[220px] min-w-[160px] h-[calc(100vh-4rem)] z-[9999] flex flex-col"
            style={{
          ...
          >
            <div className="flex flex-col w-full pt-3 pb-3 fade-in-down px-3" style={{ backgroundColor: "#000000" }}>
              <Link
                href={`${prefix}/about`}
                className="text-white text-sm font-medium py-2.5 px-2 border-b border-white/10 w-full text-center hover:bg-white/10 active:bg-white/15 transition-colors break-words"
                onClick={() => setMobileMenuOpen(false)}
              >
                {t("common.nav.about")}
              </Link>
              ...
              <Link
                ...
                className="text-white text-sm font-medium py-2.5 px-2 w-full text-center hover:bg-white/10 active:bg-white/15 transition-colors break-words"
                onClick={() => setMobileMenuOpen(false)}
              >
                {otherLocaleName}
              </Link>
